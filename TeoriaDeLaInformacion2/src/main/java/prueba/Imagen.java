...
public class Imagen {
	...
	public static void main(String[] args) {
		...
		compression_huffman.genera_fuente(false);
		...
		compression_huffman.compression_Rate(483400,"imagen.raw");
		...
		compression_shannon_fano.genera_fuente(false);
		...
		compression_shannon_fano.compression_Rate(401492,"imagen.raw");
		...
		compression_rlc.rlc("imagen.rlc",8,2);
		compression_rlc.compression_Rate(36648, "imagen.raw");
